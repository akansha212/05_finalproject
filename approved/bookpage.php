...
if($count==1){
echo "<center><h2>book details related to your search are:</h2></center>";
...
echo "<form action=send3.php >";
echo "<input type=submit value=issue_request name=submit1>";
echo "</form>";
}
else {
echo "sorry book does not exist in our library";
}
?>
<body background="bg.jpg" repeat="no-repeat">
</body>
</html>